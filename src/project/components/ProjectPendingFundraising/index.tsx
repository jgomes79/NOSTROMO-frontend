...
import styles from "./ProjectPendingFundraising.module.scss";

/**
 * Props for the ProjectPendingFundraising component.
 * @param {Project} project - The project to be published.
 */
interface ProjectPendingFundraisingProps {
  readonly project: Project;
}

/**
 * Component to display a project that is pending fundraising creation.
 * @param {ProjectPendingFundraisingProps} props - The props for the component.
 * @returns {React.ReactNode} The component to be rendered.
 */
export const ProjectPendingFundraising: React.FC<ProjectPendingFundraisingProps> = ({ project }) => {
  ...
  return (
    <Fieldset title={"Fundraising Phase"} variant={"default"}>
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          <Typography as={"h1"} variant={"heading"} size={"large"} textAlign={"center"} className={styles.green}>
            Project ready to create fundraising!
          </Typography>
          <Typography as={"p"} variant={"body"} size={"medium"} textAlign={"center"} className={styles.gray}>
            Your project has been approved by the community and is ready to be created fundraising.
            <br />
        ...
        <Typography as={"p"} variant={"body"} size={"medium"} textAlign={"center"}>
          <Button
            ...
            caption="Create Fundraising Phase"
